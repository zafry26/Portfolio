...
using BackendUnitTests.Services;
using Respawn;
...
public class TodoTasksServiceTests
{
    ...
    public async Task OneTimeSetUp()
    {
        ...
        var msSqlDockerConnectionString =
            $"Server=tcp:{containerInfo.Host},{containerInfo.Port};Encrypt=False;Database=AspNetBackend;MultipleActiveResultSets=true;User ID=SA;Password={Defaults.DbPassword}";
